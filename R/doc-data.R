...
#' inst/extdata/Exp1_R25_pept.txt), or as a \code{MSnSet} structure 
...
#' 
#' The data frame fData(Exp1_R25_pept) contains the meta data about the 
#' peptides.
#' 
#' The data frame pData(Exp1_R25_pept) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references Cox J., Hein M.Y., Luber C.A., Paron I., Nagaraj N., Mann M. 
#' Accurate proteome-wide label-free quantification by delayed normalization 
...
#' 
#' The dataset is either available as a CSV file 
#' (see inst/extdata/Exp1_R2_prot.txt), or as a \code{MSnSet} structure 
#' (Exp1_R2_prot.MSnset). In the latter case, the quantitative data are those 
#' of the raw intensities.
...
#' 
#' The data frame pData(Exp1_R2_prot) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references Cox J., Hein M.Y., Luber C.A., Paron I., Nagaraj N., Mann M. 
#' Accurate proteome-wide label-free quantification by delayed normalization 
...
#' of 2.Three technical replicates were acquired for each condition.
#' 
#' The dataset is either available as a CSV file (see 
#' inst/extdata/Exp1_R2_pept.txt), or as a \code{MSnSet} structure 
...
#' 
#' The data frame pData(Exp1_R2_pept) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references Cox J., Hein M.Y., Luber C.A., Paron I., Nagaraj N., Mann M. 
#' Accurate proteome-wide label-free quantification by delayed normalization 
...
#' 
#' The dataset is either available as a CSV file 
#' (see inst/extdata/Exp2_R2_prot.txt), or as a \code{MSnSet} structure 
#' (Exp2_R2_prot.MSnset). In the latter case, the quantitative data are those 
#' of the raw intensities.
...
#' 
#' The data frame pData(Exp2_R2_prot) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references 
...
#' 
#' The dataset is either available as a CSV file 
#' (see inst/extdata/Exp2_R2_pept.txt), or as a \code{MSnSet} structure 
#' (Exp2_R2_pept.MSnset). In the latter case, the quantitative data are those 
#' of the raw intensities.
#' @usage data(Exp2_R2_pept)
#' @return An object of class \code{MSnSet} related to peptides
#' quantification.
#' @format An object of class \code{MSnSet} related to peptides
#' quantification. It contains 6 samples divided into two conditions
...
#' 
#' The data frame pData(Exp2_R2_pept) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references
#' Ramus C, Hovasse A, Marcellin M, Hesse AM, Mouton-Barbosa E, Bouyssie D, 
...
#' yeast peptides identified and quantified in these two conditions. The two 
#' conditions represent the measured abundances of peptides when respectively 
#' 10 fmol and 100 fmol of UPS1 human proteins were mixed with the yeast 
#' extract before mass spectrometry analyses. This results in a concentration 
#' ratio of 10. Three technical replicates were acquired for each condition.
#' 
#' 
#' The dataset is either available as a CSV file 
#' (see inst/extdata/Exp2_R10_prot.txt), or as a \code{MSnSet} structure 
#' (Exp2_R10_prot.MSnset). In the latter case, the quantitative data are 
...
#' quantitation of proteins for the six replicates. 
#' 
#' The data frame fData(Exp2_R10_prot) contains the meta data about the 
#' proteins.
#' 
#' The data frame pData(Exp2_R10_prot) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references
#' Ramus C, Hovasse A, Marcellin M, Hesse AM, Mouton-Barbosa E, Bouyssie D, 
...
#' 
#' The dataset is either available as a CSV file 
#' (see inst/extdata/Exp2_R10_pept.txt), or as a \code{MSnSet} structure 
#' (Exp2_R10_pept.MSnset). In the latter case, the quantitative data are 
#' those of the raw intensities.
...
#' quantitation of peptides for the six replicates. 
#' 
#' The data frame fData(Exp2_R10_pept) contains the meta data about the 
#' peptides.
#' 
#' The data frame pData(Exp2_R10_pept) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references
#' Ramus C, Hovasse A, Marcellin M, Hesse AM, Mouton-Barbosa E, Bouyssie D, 
...
#' 
#' The dataset is either available as a CSV file 
#' (see inst/extdata/Exp2_R100_pept.txt), or as a \code{MSnSet} 
#' structure (Exp2_R100_peptt.MSnset). In the latter case, the quantitative 
#' data are those of the raw intensities.
...
#' quantitation of peptides for the six replicates. 
#' 
#' The data frame fData(Exp2_R100_pept) contains the meta data about the 
#' peptides
#' 
#' The data frame pData(Exp2_R100_pept) contains the experimental design and 
#' gives few informations about the samples.
#' 
#' @references
#' Ramus C, Hovasse A, Marcellin M, Hesse AM, Mouton-Barbosa E, Bouyssie D, 
